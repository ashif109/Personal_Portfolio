...
const Footer = () => {
    ...
    return (
        <div className='bg-gray-950 py-8 px-4 text-center'>
            <div className="text-2xl bg-linear-to-r from-red-500 to-orange-500 bg-clip-text text-transparent font-bold tracking-wide hover:text-red-600 mb-6">
                ASHIF.Dev</div>

            <div className='text-gray-500 mb-6'>
                <ul className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 text-sm font-semibold">
                    <li>
            ...
            <div className="text-white flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mb-4">
            ...
            <h3 className='text-gray-700 text-sm'>Developed & Designed by-@Ashif_Ansari</h3>
        </div>
    )
}

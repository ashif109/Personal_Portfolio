        ...
        <div>
            <div className='text-center px-4 py-10'>
                ...
                <div className='grid w-full gap-6 rounded-3xl p-6 shadow-lg sm:grid-cols-3'>
                    <div className='flex flex-col items-center gap-4 overflow-hidden rounded-3xl bg-slate-900/60 p-6 text-center transition duration-300 ease-out transform hover:-translate-y-2 hover:scale-105 hover:bg-slate-800/90 hover:shadow-2xl cursor-pointer'>
                        ...
                        <a
                            ...
                            className="relative z-10 rounded-full bg-amber-500 px-6 py-3 text-sm font-semibold text-slate-900 transition hover:bg-amber-400 inline-block"
                        >
                            See Details
                        </a>
                    </div>

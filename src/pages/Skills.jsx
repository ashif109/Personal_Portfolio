...
const Skills = () => {
    ...
    return (
        <div className='text-center px-4 py-10'>
            ...
            <div className='relative z-10 grid w-full gap-6 rounded-3xl p-6 shadow-lg grid-cols-1 md:grid-cols-3'>
                <div className='flex flex-col items-center gap-4 rounded-3xl bg-slate-900/60 p-6 text-center transition-all duration-500 ease-out transform hover:-translate-y-2 hover:scale-105 hover:bg-slate-800/90 hover:shadow-2xl'>
